...
const RegisterPage = () => {
    ...
    const registerUser = async () => {
        ...
        if (!validatePassword(password)) {
            errorMessage += 'Password must be at least 10 characters long, include at least one uppercase letter, one lowercase letter, one number, and one special character.';
        }

        if (errorMessage) {
            setPopupMessage(errorMessage.trim());
                    ...
                    <div className="w-full max-w-sm md:max-w-md">
                        <div className="bg-white text-gray-700 rounded-lg shadow-xl">
                            <div className="p-5 text-center">
                                ...
                                <h2 className="text-2xl font-bold mb-7 uppercase">Register</h2>
                                <div className="w-full mb-4">
                                    <div className="relative h-10 w-full min-w-[200px]">
                                        <input
                                            ...
                                            placeholder=" "
                                        />
                                        <label className="pointer-events-none absolute left-0 -top-1.5 flex h-full w-full select-none text-[11px] text-blue-gray-400 transition-all before:content-[' '] before:pointer-events-none before:mt-[6.5px] before:mr-1 before:block before:h-1.5 before:w-2.5 before:rounded-tl-md before:border-t before:border-l before:border-blue-gray-200 after:content-[' '] after:pointer-events-none after:mt-[6.5px] after:ml-1 after:block after:h-1.5 after:w-2.5 after:flex-grow after:rounded-tr-md after:border-t after:border-r after:border-blue-gray-200 peer-placeholder-shown:text-sm peer-placeholder-shown:text-blue-gray-500 peer-focus:text-[11px] peer-focus:text-blue-500 peer-focus:before:border-t-2 peer-focus:before:border-l-2 peer-focus:before:border-blue-500 peer-focus:after:border-t-2 peer-focus:after:border-r-2 peer-focus:after:border-blue-500">
                                            Email
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="mt-5">
                                    <p className="text-xs">
                                        ...
                                        <a href="/login" className="text-gray-400 font-bold hover:text-webblue transition duration-300"> Sign In</a>
                                    </p>
                                </div>
                            </div>
                        </div>
